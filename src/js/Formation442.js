...
return (
    ...
    <div className="formation">
      ...
      <div className="row">
          ...
          <div className="col-3 height">{typeof myTeam[4] !== "undefined" ? (<div className="card"><span className="span"><img width="100px" heigth="150px" src={myTeam[4]._i}/></span><div className="name"><span>{myTeam[4]._f}</span> <span>{myTeam[4]._s}</span></div></div>) : shoe}</div>
          <div className="col-3 height">{typeof myTeam[5] !== "undefined" ? (<div className="card"><span className="span"><img width="100px" heigth="150px" src={myTeam[5]._i}/></span><div className="name"><span>{myTeam[5]._f}</span> <span>{myTeam[5]._s}</span></div></div>) : shoe}</div>
