  ...
  return (
    ...
    <div className="formation">
      ...
      <div className="row">
          ...
          <div className="col-3 height">{typeof myTeam[4] !== "undefined" ? (<div className="card"><img width="100px" heigth="150px" src={myTeam[4]._i}/><div className="name">{myTeam[4]._f} {myTeam[4]._s}</div></div>) : shoe}</div>
          <div className="col-3 height">{typeof myTeam[5] !== "undefined" ? (<div className="card"><img width="100px" heigth="150px" src={myTeam[5]._i}/><div className="name">{myTeam[5]._f} {myTeam[5]._s}</div></div>) : shoe}</div>
